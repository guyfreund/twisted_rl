...
from mujoco_infra.mujoco_utils.general_utils import comperae_two_high_level_states
import numpy as np
...
class GraphManager():
    ...
    def add_node(self, topology_state, configuration, parent_id, action, episode=None):
        node_attribute_dict = {
        ...
        if parent_id is not None:
            self.add_edge(parent_id, self.id, {"action": action, "episode": episode})
        else:
