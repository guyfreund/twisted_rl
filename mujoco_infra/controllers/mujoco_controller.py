...
from mujoco_infra.mujoco_utils.mujoco import create_spline_from_points, get_number_of_links,\
...
class MujocoController():
    ...
    def execute_action(self, physics:mujoco.Physics ,action:list, output_path:str):
        ...
        if self.save_video:
            save_video_from_images(images=self.video, output_path=output_path, sample_rate_from_data=1)
